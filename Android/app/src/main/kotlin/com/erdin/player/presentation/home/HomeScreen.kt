...
import com.erdin.player.presentation.common.NativeAdCard
import com.erdin.player.presentation.common.StreamLogoRow
import com.erdin.player.presentation.common.StreamPosterCard
...
private fun shareLogs(context: android.content.Context) {
    ...
    val uri = FileProvider.getUriForFile(context, "com.erdin.player.fileprovider", logFile)
