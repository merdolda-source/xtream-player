...
import xtream.emin.player.data.local.entities.toDomain
import xtream.emin.player.data.local.entities.toFavoriteEntity
import xtream.emin.player.data.local.entities.toWatchHistoryEntity
import xtream.emin.player.data.remote.api.XtreamApiService
import xtream.emin.player.data.remote.api.XtreamUrlBuilder
import xtream.emin.player.data.remote.dto.toDomain
...
import xtream.emin.player.domain.usecases.HistoryRecorder
 ...
 * [HistoryRecorder] so [xtream.emin.player.domain.usecases.RecordWatchHistoryUseCase]
